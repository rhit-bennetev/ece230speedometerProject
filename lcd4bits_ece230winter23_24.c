//File Name: lcd4bits_ece230winter23_24.c
...
#define LCD_DATA        P5       //Data port -LCD Data pins (D0 - D7)
...
void lcd4bits_init(void)
{
    ...
    DelayMs(1); // wait 15mSec after power applied,
    lcd8bits_write(CMD_MODE, LCDCMD_FunctionSet_4bits); // function set: 8-bit mode, 2 lines, 5x7 dots
