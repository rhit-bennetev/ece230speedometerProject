...
#define CURSOR_SHIFT_MASK   XXXX
#define FUNCTION_SET_MASK   0x03B
#define SET_CGRAM_MASK      XXXX
...
extern void lcd_SetLineNumber(unsigned char position);
//*****************************************************************************
//
